...
BUILTIN_MANIFEST = [
    ...
    {
        "id": "wordnet_pos_full",
        "file": "wordnet_pos_full.json",
        "display_name": "WordNet POS (Full)",
        "description": "Complete part-of-speech membership from WordNet 3.1 — 147K lemmas across noun, verb, adjective, adverb.",
        "license": "Princeton WordNet License",
        "citation": "Fellbaum (1998)",
        "categories_preview": ["noun", "verb", "adjective", "adverb"],
        "enabled_by_default": False,
    ...
    {
        "id": "warriner_vad",
        "file": "warriner_vad.json",
        "display_name": "Warriner VAD Norms",
        "description": "Valence (1-9), Arousal (1-9), and Dominance (1-9) ratings for 13,915 English lemmas.",
        "license": "CC-BY",
        "citation": "Warriner et al. (2013)",
        "categories_preview": ["valence", "arousal", "dominance"],
        "enabled_by_default": False,
    },
    {
        "id": "empath",
        "file": "empath.json",
        "display_name": "Empath",
        "description": "194 crowdsourced topic categories (affect, cognition, social, content domains). Built from 1.8M stories.",
        "license": "MIT",
        "citation": "Fast, Chen, & Bernstein (2016)",
        "categories_preview": ["achievement", "affection", "aggression", "anger", "anticipation",
                               "communication", "fear", "joy", "sadness", "trust"],
        "enabled_by_default": False,
    },
    {
        "id": "nrc_emolex",
        "file": "nrc_emolex.json",
        "display_name": "NRC Emotion Lexicon (EmoLex)",
        "description": "8 emotions (anger, anticipation, disgust, fear, joy, sadness, surprise, trust) + positive/negative for 14,000+ words.",
        "license": "Free for research; commercial use requires NRC permission",
        "citation": "Mohammad & Turney (2013)",
        "categories_preview": ["anger", "anticipation", "disgust", "fear", "joy",
                               "sadness", "surprise", "trust", "positive", "negative"],
        "enabled_by_default": False,
        "optional_download": True,
        "download_notice": (
            "The NRC Emotion Lexicon is free for research but requires permission for "
            "commercial use. Download from https://saifmohammad.com/WebPages/NRC-Emotion-Lexicon.htm "
            "and import via File → Import Dictionary."
        ),
    },
    {
        "id": "sentiwordnet",
